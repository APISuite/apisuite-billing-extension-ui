...
export const GET_ALL_USER_DETAILS_ACTION_SUCCESS = 'Billing/GET_ALL_USER_DETAILS_ACTION_SUCCESS';
export const GET_ALL_CREDIT_PACKS_ACTION = 'Billing/GET_ALL_CREDIT_PACKS_ACTION';
export const GET_ALL_CREDIT_PACKS_ACTION_SUCCESS = 'Billing/GET_ALL_CREDIT_PACKS_ACTION_SUCCESS';
export const GET_ALL_SUBSCRIPTION_PLANS_ACTION = 'Billing/GET_ALL_SUBSCRIPTION_PLANS_ACTION';
...
/** Action builders */
export function getAllUserDetailsAction(userID) {
...
export function getTransactionDetailsAction(transactionID) {
...
export function startSubscriptionAction(subscriptionPlanID) {
